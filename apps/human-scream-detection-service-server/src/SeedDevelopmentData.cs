using HumanScreamDetectionService.Infrastructure;
using HumanScreamDetectionService.Infrastructure.Models;
using Microsoft.AspNetCore.Identity;
using Microsoft.AspNetCore.Identity.EntityFrameworkCore;

namespace HumanScreamDetectionService;
...
public class SeedDevelopmentData
{
    ...
    {
        var context = serviceProvider.GetRequiredService<HumanScreamDetectionServiceDbContext>();
